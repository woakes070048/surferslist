...
class Weight {
	...
	public function __construct($registry) {
		...
		if (!$weight_class_data) {
			...
			$this->cache->set('weight_class.' . (int)$this->config->get('config_language_id'), $weight_class_data, 60 * 60 * 24 * 365); // 1 year cache expiration
		}

		$this->weights = $weight_class_data;
	}
