...
class ControllerCheckoutGuest extends Controller {
	...
	public function validate() {
		...
		if (!$json) {
			...
			if (!isset($this->request->post['address_1']) || !$this->validateStringLength($this->request->post['address_1'], 3, 32)) {
				$json['error']['address_1'] = $this->language->get('error_address_1');
			}

			if (!isset($this->request->post['city']) || !$this->validateStringLength($this->request->post['city'], 3, 32)) {
