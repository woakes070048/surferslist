...
class ControllerPaymentPPExpress extends Controller {
	...
	public function expressConfirm() {
		...
		$this->data['heading_title'] = $this->language->get('express_text_title');

		$this->addBreadcrumb($this->language->get('text_home'), $this->url->link('common/home'));
		$this->addBreadcrumb($this->language->get('text_title'), $this->url->link('payment/pp_express/express'));
		$this->addBreadcrumb($this->language->get('express_text_title'), $this->url->link('payment/pp_express/expressConfirm'));
