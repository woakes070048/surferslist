<?php echo $header; ?>
<main class="container-page category-page">
    <header class="breadcrumb">
        <div class="layout">
            <h1><a href="<?php echo $action; ?>"><span class="category-icon icon-<?php echo $category_icon; ?>"></span><?php echo $heading_title; ?></a></h1>
            <div class="links">
