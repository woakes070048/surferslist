			...
			<div class="right-item">
				<div class="product-info">
					<ul class="global-attribute">
						...
						<li><b><?php echo $text_location; ?></b> <i><?php echo !empty($location) ? $location . ' - ' : ''; ?><a href="<?php echo $location_href; ?>"><?php echo $location_zone . ', ' . $location_country; ?></a></i></li>
						<?php } ?>
						<?php if ($shipping_display && $price && $type_id >= 0) { ?>
						<li><b><?php echo $text_shipping; ?></b> <i><?php echo $shipping; ?></i></li>
						<?php } ?>
						<?php if ($learn_more && $member_customer_id == 0) { ?>
				...
				<div id="buttons-item" class="buttons buttons-middle">
					<div class="center">
						...
						<?php if ($learn_more) { ?>
						<a href="<?php echo $learn_more; ?>" target="_blank" class="button button_alt bigger fullwidth" title="<?php echo $help_button_learn_more; ?>" rel="tooltip" data-container="body">
							<i class="fa fa-external-link-square"></i> <?php echo $button_learn_more; ?>
						</a>
						<?php } ?>
					</div>
				</div>
