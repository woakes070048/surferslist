    ...
    <div class="layout">
        ...
        <div class="container-center">
            <div class="content-page my-account my-profile">
                ...
                <div class="widget-container clearafter">

                    <?php if ($activated && $enabled) { ?>
                    <div class="widget grid-3">
    					<h6><?php echo $text_member; ?><a href="<?php echo $member; ?>" class="float-right"><span class="help"><?php echo $button_edit; ?></span></a></h6>
                        ...
                        <div class="buttons">
                            <div class="center">
                                <a href="<?php echo $member_page; ?>" class="button button_highlight fullwidth"><i class="fa fa-user"></i><?php echo $text_member_view; ?></a>
                            </div>
                        </div>
                    </div>

                    <div class="widget grid-6">
    					<h6><?php echo $text_member_info; ?><a href="<?php echo $member; ?>" class="float-right"><span class="help"><?php echo $button_edit; ?></span></a></h6>
				...
				<div class="widget-container clearafter">
                    ...
                    <div class="widget grid-2">
    					<h6><?php echo $text_personal; ?><a href="<?php echo $edit; ?>" class="float-right"><span class="help"><?php echo $button_edit; ?></span></a></h6>
                    ...
                    <div class="widget grid-2">
    					<h6><?php echo $text_account_activity; ?></h6>
