...
$_['text_services'] = <<<EOT
Log in to %s to:
- participate in discussions and send private messages faster
- place orders for listings offered for sale by other users
- activate a profile to start posting your own quiver and offer items for sale
- post anonymous listings that don't require approval
- save a list of listings for later reference
EOT;
